...
data1.Dl << 1 << 0 << 1 << 1 << 2580   << 1 << 0*Rpv << 0*Rsst << 0*Rpv << 0*Rsst << 0*Rpv << 0*Rsst << 0*Rcap << 1 << 1 << 1 << arma::endr
	 ...
	 << 33 << 17 << 33 << 2 << 860 << 1 << 27*Rpv << 16*Rsst << 31*Rpv << 18*Rsst << 9*Rpv << 7*Rsst << 0*Rcap << 1 << 1 << 1 << arma::endr;
		...
		arma::mat R, X;//in ohms
	      R << 1.3238 << 0.2109 << 0.2051 << arma::endr
		<< 0.2109 << 1.3385 << 0.2124 << arma::endr
		<< 0.2051 << 0.2124 << 1.3266 << arma::endr// 300
		<< 1.9157 << 0.2336 << 0.2273 << arma::endr
		<< 0.2336 << 1.9318 << 0.2352 << arma::endr
		<< 0.2273 << 0.2352 << 1.9188 << arma::endr// 301
		<< 2.7799 << 0 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 302
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 2.7799 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 303
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 1.9216 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 304
		...
		<< 0 << 0 << 0 << arma::endr;// VR
	      ...
	      X << 1.3570 << 0.5965 << 0.4616 << arma::endr
		<< 0.5965 << 1.3313 << 0.5026 << arma::endr
		<< 0.4616 << 0.5026 << 1.3521 << arma::endr// 300
		<< 1.4282 << 0.6431 << 0.5256 << arma::endr
		<< 0.6431 << 1.4094 << 0.5699 << arma::endr
		<< 0.5256 << 0.5699 << 1.4246 << arma::endr// 301
		<< 1.4804 << 0 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 302
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 1.4804 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 303
		<< 0 << 0 << 0 << arma::endr
		<< 0 << 1.4213 << 0 << arma::endr
		<< 0 << 0 << 0 << arma::endr// 304
