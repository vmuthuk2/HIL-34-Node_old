...
void VVCAgent::vvc_slave()
{
  ...
  if (status == true)
  {
	  ...
	  sstA_cmd = 0;
    	  //tempB = join_rows(Grad_slave1.row(12),Grad_slave1.row(13),Grad_slave1.rows(20,21));
    	  //tempB1 = join_rows(Grad_slave1.row(13),Grad_slave1.row(21));
	  //tempB2 = join_rows(Grad_slave1.row(20),Grad_slave1.row(21));
	  sstB_cmd = mean(mean(join_cols(Grad_slave1.row(13),Grad_slave1.row(21))));
	  sstC_cmd = 0;
  }
  else
  {
  ...
  std::cout << "SSTs under Slave #3: SST5 SST6 \n" << endl;
